...
<head>
	...
	<meta http-equiv="X-UA-Compatible">
   	...
   	<title>SB Admin 2 - SideBar</title>
	...
	<!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #000000;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${path}/home">
                ...
                <div class="sidebar-brand-text mx-3">REIDLO-SPRING</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<c:url value='/member/login'/>">Login</a>
                        <a class="collapse-item" href="<c:url value='/member/registerPage'/>">Register</a>
                        <a class="collapse-item" href="<c:url value='/member/modify'/>">Forgot Password</a>
